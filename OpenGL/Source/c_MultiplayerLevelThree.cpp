...
//		playerOne->SetOSlowed(false);
	...
	if (playerOne->gotCollide("Checkpoint2", false))
	{
		if (OCheckcount == 1)
			OCheckcount = 2;
	...
	if (playerOne->gotCollide("Checkpoint3", false))
	{
		if (OCheckcount == 2)
			OCheckcount = 3;
	...
	if (playerTwo->gotCollide("Checkpoint2", false))
	{
		if (TCheckcount == 1)
			TCheckcount = 2;
	...
	if (playerTwo->gotCollide("Checkpoint3", false))
	{
		if (TCheckcount == 2)
			TCheckcount = 3;
...
void c_MultiplayerLevelThree::RenderMesh(Mesh *mesh, bool enableLight)
{
...
void c_MultiplayerLevelThree::RenderTextOnScreen(Mesh* mesh, std::string text, Color color, float size, float x, float y)
{
...
void c_MultiplayerLevelThree::initLights()
{
	/***********************************************	Light 1		***************************************************************************/
...
void c_MultiplayerLevelThree::renderLights()
{
	/***********************************************	Light 1		***************************************************************************/
...
void c_MultiplayerLevelThree::updateLights(int num)
{
	if (num == 0)
	{
...
void c_MultiplayerLevelThree::renderPlayerOne()
{
...
void c_MultiplayerLevelThree::RenderSpeedometerOne()
{
	...
	modelStack.Rotate(-playerOne->GetSpedoSpeed() / 3, 0, 0, 1);
...
void c_MultiplayerLevelThree::RenderSpeedometerTwo()
{
	...
	modelStack.Translate(9, 11, 2);
	modelStack.Rotate(220, 0, 0, 1); //Velocity 0 = 220, Ve20 = 198, Ve40 = 176 etc.
	modelStack.Rotate(-playerTwo->GetSpedoSpeed() / 3, 0, 0, 1);
	modelStack.Scale(7, 7, 7);
	RenderMesh(needle.getMesh(), false);
	modelStack.PopMatrix();
	modelStack.PopMatrix();
