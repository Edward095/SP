...
void c_MainMenu::RenderMesh(Mesh *mesh, bool enableLight)
{
...
void c_MainMenu::updateLights(int num)
{
	if (num == 0)
	{
...
void c_MainMenu::renderSelection()
{
